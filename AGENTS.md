...
- CoreProtect is not installed. Introduce it after the replacement Main baseline is finalized and before substantial Hub/Gate construction; keep rollback administration Admin-only and do not treat it as a cold-backup replacement. Placement and database policy require a separate approved task.
