...
- The Ver.0.0.6 replacement generation completed on 2026-07-25 with seed `164225356311935743` and is the Current Runtime Candidate. Persistent storage remains `servers/main/main/dimensions/minecraft/{overworld,the_nether,the_end}`. It is not the Final V0.1.0 Main Baseline: generation acceptance still lacks natural-generation evidence from a fourth distinct Pack, and Order 6 Weight／Content tuning plus the final baseline backup remain incomplete.
...
- The one-time Ver.0.0.6 replacement generation is complete. Never rerun its task or include `resource`, `resource_nether`, or `resource_end` in any Main lifecycle operation. The generated family remains a Runtime Candidate until the exact Order 5 remainder and all Order 6 tuning／backup work complete.
