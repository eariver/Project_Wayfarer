...
- The Ver.0.0.6 replacement generation completed on 2026-07-25 with seed `164225356311935743` and is the Current Runtime Candidate. Persistent storage remains `servers/main/main/dimensions/minecraft/{overworld,the_nether,the_end}`. Order 5 generation acceptance is complete after natural generation of Exploration Pack `betterstructures_exploration_bridgecave_shallow`; it is still not the Final V0.1.0 Main Baseline because Order 6 Weight／Content tuning and the final baseline backup remain incomplete.
...
- The Current Runtime Candidate rollback source is the verified ignored local backup `backups/main-v006-replacement-generation-20260725-154934/`, with manifest SHA-256 `C79C2FC3ECBA998D875200E1D29B1B82B9BE97808B965E28D74B60108F62B118`. It contains the complete replaced Main container. The last finalized 2026-07-21 baseline also remains locally backed up at `backups/main-final-generation-20260721-001501/` with manifest SHA-256 `50B0F6244223DA68B752407BBE89127E0CE49645F7673A5FF929EE9C5B8A3C9D`. Neither backup is stored in Git or guaranteed in another clone.
...
- BetterStructures places structures only in newly generated chunks. The default `spawnProtectionRadius: 100` was explicitly retained for the Current Runtime Candidate.
- Natural generation is accepted from four distinct Main Packs: Default, Caves and Lost Civilizations Free, Echoes of the Past, and Exploration Pack. The fourth-Pack test added six Overworld Region files, changing the Current Runtime Candidate counts to `17 / 11 / 18`; Nether, End, and every Resource Region were unchanged. Do not rerun that bounded exploration task.
...
- The one-time Ver.0.0.6 replacement generation and Order 5 acceptance are complete. Never rerun either task or include `resource`, `resource_nether`, or `resource_end` in any Main lifecycle operation. The generated family remains a Runtime Candidate until all Order 6 tuning／backup work completes.
