...
- Wayfarer_Core and Wayfarer_Frontier are required V0.1.0 external custom Plugins and Release Blockers. Each is designed, developed, built, and released from a separate Repository under separately assigned tasks.
...
- The Frontier V0.0.4 Concept files under `concepts/frontier/` are detailed, non-authoritative design inputs, not implementation tasks. Only the scope explicitly promoted into Ver.0.0.6 source-of-truth documents may be designed into separately assigned implementation tasks.
