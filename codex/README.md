...
| [Main Order 6 Tuning and Final Baseline](Project_Wayfarer_Main_Order6_Tuning_and_Final_Baseline.md) | 実施中 | 2026-07-25 | [Main World Baseline](../docs/13-main-world-baseline.md)、[Roadmap](../docs/09-roadmap.md) | Final Baseline確定前。確定後はそのまま再実行禁止 |
