...
| [Frontier Order 8 Artifact／World／Runtime Lock](Project_Wayfarer_Frontier_Order8_Artifact_World_and_Runtime_Lock.md) | 承認待ち（Proposal: `FRONTIER-LOCK-20260726-002`） | 2026-07-26 | [Preflight](../docs/investigations/2026-07-26-frontier-order8-lock-preflight.md)、[Frontier Scope](../docs/14-frontier-v0.1.0-scope.md) | Phase A Revision 002。Worlds BeyondはIris Overworld単独。Exact Approval前にPhase Bを実行しない |
