...
| [Ver.0.0.6 Formal Scope and Roadmap Update](Project_Wayfarer_Ver0.0.6_Formal_Scope_and_Roadmap_Update.md) | 完了（実装Commit: `PENDING`） | 2026-07-25 | `AGENTS.md`、[Design Guide](../docs/00-design-guide.md)、[Architecture](../docs/01-architecture.md)、[Roadmap](../docs/09-roadmap.md)、[Frontier Scope](../docs/14-frontier-v0.1.0-scope.md) | そのままの再実行禁止。実装進行後は現行Runtimeと正本文書で再評価 |
