...
| [Main Fourth Pack Natural Generation Acceptance](Project_Wayfarer_Main_Fourth_Pack_Natural_Generation_Acceptance.md) | 完了（実装Commitは追補Commitで記録） | 2026-07-25 | [Investigation](../docs/investigations/2026-07-25-main-fourth-pack-natural-generation.md)、[Main World Baseline](../docs/13-main-world-baseline.md)、[Roadmap](../docs/09-roadmap.md)、[Acceptance Tests](../docs/06-acceptance-tests.md) | 完了後はそのまま再実行禁止。Order 6は別Task |
