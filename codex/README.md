...
| [Frontier Order 8 Artifact／World／Runtime Lock](Project_Wayfarer_Frontier_Order8_Artifact_World_and_Runtime_Lock.md) | 完了（実装Commit: `201681ea026936909558839bc4445d9ccb7be567`、記録Commit: `ebb100afce96cd467e4e4de93b039c3e8ecaf77a`、追補Commit: `fe16ca6c6200732ee4b1960126ecb8f5dcb96795`） | 2026-07-26 | [Runtime Lock](../docs/15-frontier-runtime-lock.md)、[Formal Lock Report](../docs/investigations/2026-07-26-frontier-order8-lock.md)、[Preflight](../docs/investigations/2026-07-26-frontier-order8-lock-preflight.md) | そのまま再実行禁止。Artifact、World ID、MVI、Gate、PackまたはAuthority変更は新しいFrontier Lock Revision Task |
| [Plugin Scope and Frontier Lock Revision 003 Resync](Project_Wayfarer_Plugin_Scope_and_Frontier_Lock_Revision003_Resync.md) | 完了（実装Commit: `e23906c427749d49d415961e9b6c798a0640e98e`） | 2026-07-26 | [Revision 003 investigation](../docs/investigations/2026-07-26-plugin-scope-and-frontier-lock-revision003-resync.md)、[Frontier preflight](../docs/investigations/2026-07-26-frontier-order8-lock-preflight.md) | Revision 003はOrder 8 Phase Bで正式Lock済み。そのまま再実行禁止 |
| [Frontier Lock Post-Approval Document Alignment](Project_Wayfarer_Frontier_Lock_Post_Approval_Document_Alignment.md) | 完了（実装Commit: `3bdca32f385e979d98e3e776ac98f35521581126`） | 2026-07-26 | [Acceptance Tests](../docs/06-acceptance-tests.md)、[Frontier Scope](../docs/14-frontier-v0.1.0-scope.md)、[Formal Lock Report](../docs/investigations/2026-07-26-frontier-order8-lock.md) | そのまま再実行禁止。Lock変更は新Revision Task、Growth Pickaxe Gameplay変更は新しいMain Plugin Concept／Design Task |
