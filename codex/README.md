...
| [Main Persistent Family Replacement Generation and Acceptance](Project_Wayfarer_Main_Persistent_Family_Replacement_Generation_and_Acceptance.md) | 限定受入完了（実装Commitは追補Commitで記録） | 2026-07-25 | [Investigation](../docs/investigations/2026-07-25-main-v006-replacement-generation.md)、[Main World Baseline](../docs/13-main-world-baseline.md)、[Roadmap](../docs/09-roadmap.md)、[Acceptance Tests](../docs/06-acceptance-tests.md) | 置換生成は再実行禁止。4 Pack目の自然生成確認とOrder 6は別Task |
