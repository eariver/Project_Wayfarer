...
| [Main BetterStructures Preflight and Content Integration](Project_Wayfarer_Main_BetterStructures_Preflight_and_Content_Integration.md) | 実施中 | 2026-07-25 | [Investigation](../docs/investigations/2026-07-25-main-betterstructures-content-preflight.md)、[Main World Baseline](../docs/13-main-world-baseline.md)、[Roadmap](../docs/09-roadmap.md) | Phase A停止後は追加Artifactと現行Git状態を再監査して再開可能。完了後はそのまま再実行禁止 |
