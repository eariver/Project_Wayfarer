# Project Wayfarer — Ruined Frontier仕様書 V0.0.4
...
- Frontier LobbyにはAdventurer's Guildへ接続する物理Guild Gateを配置する。V0.0.4ではTheme選択GUIを使用しない。
...
- ResurrectionChest等はV0.0.4必須としない。
...
これらはV0.0.4仕様を破棄する未決事項ではなく、ArtifactおよびRuntime依存の実装Lock項目である。
