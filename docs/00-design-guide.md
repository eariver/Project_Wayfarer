...
Waymark共有残高とmcMMO共有進行は導入済みです。Advanced Portals、EconomyShopGUI、BetterStructures、EvenMoreFish、EliteMobs、Waymark報酬およびCross-server Chatは未導入であり、計画上の機能を導入済みとして扱いません。
